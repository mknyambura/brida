...
function Program() {
  return (
    <div className='text-white'>
        <Header/>
        <div className='bg-[#060919]  flex flex-row items-center justify-evenly'>
            <div className='flex flex-col gap-8 ml-16 w-[45%]'>
                <h1 className='text-6xl font-bold'>Let's learn Informatics Engineering</h1>
        ...
        <div className='flex flex-col text-black text-center items-center gap-8 m-16'>
            <div>
                <h1c className='text-4xl font-bold'>Things you'll learn</h1c>
            ...
            <div className=' flex flex-row flex-wrap gap-8 items-center justify-center w-[80%]'>
                <ul className='flex flex-row  flex-wrap list-disc marker:text-white text-white gap-16 text-center items-center justify-center'>
                    ...
                    <li className='bg-[#FFC947] px-12 py-2 rounded-xl'>Growth hacks for Github</li>
                    <li className='bg-[#FF9B00] px-12 py-2 rounded-xl'>Learn website development</li>
                    <li className='bg-[#ED1C24] px-12 py-2 rounded-xl'>Learn to build a portfolio</li>
                    <li className='bg-[#0001F1] px-12 py-2 rounded-xl'>How to find the perfect niche</li>
                </ul>
            </div>
        </div>
        
        <div className='flex flex-row-reverse items-center justify-between m-16'>
            {/* <div> */}
                <img src={video} alt="" />
            {/* </div> */}
            <div className='m-6 flex flex-col gap-10 w-1/2'>
                <h1 className='text-black font-bold text-6xl text-center'>Get to know the Informatic Enginering major </h1>
